...
RSpec.describe FathersController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all fathers as @fathers" do
      ...
      expect(assigns(:fathers)).to eq([father])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested father as @father" do
      ...
      expect(assigns(:father)).to eq(father)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new father as @father" do
      ...
      expect(assigns(:father)).to be_a_new(Father)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created father as @father" do
        post :create, {:father => valid_attributes}, valid_session
        expect(assigns(:father)).to be_a(Father)
        expect(assigns(:father)).to be_persisted
      end

      it "redirects to the created father" do
        post :create, {:father => valid_attributes}, valid_session
        expect(response).to redirect_to(Father.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved father as @father" do
        post :create, {:father => invalid_attributes}, valid_session
        expect(assigns(:father)).to be_a_new(Father)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested father" do
        father = Father.create! valid_attributes
        put :update, {:id => father.to_param, :father => new_attributes}, valid_session
        father.reload
      ...
      it "redirects to the father" do
        father = Father.create! valid_attributes
        put :update, {:id => father.to_param, :father => valid_attributes}, valid_session
        expect(response).to redirect_to(father)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the father as @father" do
        father = Father.create! valid_attributes
        put :update, {:id => father.to_param, :father => invalid_attributes}, valid_session
        expect(assigns(:father)).to eq(father)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the fathers list" do
      father = Father.create! valid_attributes
      delete :destroy, {:id => father.to_param}, valid_session
      expect(response).to redirect_to(fathers_url)
    end
  end
